...
function Certifications() {
    ...
    //     <div className= 'certBg' style={{backgroundImage:`url(${servicesBg})`}}>
    //         <h1 className="font-face-gm" style={{ color: 'rgba(0, 171, 252,.8)', textAlign: 'left', marginTop: '15px', marginLeft: '30px', marginBottom: '75px'}}>
    //         Certifications
    //         </h1>
    //         <div className="wrapper">
    //         <div class="container">
    //         <div class="cardServices mb-3" style={{ color: 'rgba(222, 185, 146)', background:'rgba(15, 34, 75)', opacity: 0.79, marginLeft: '30px'}}>
    //             <div class="card-body">
    //                 <p class="card-text">
    //                     <h3>ASQ Certified Quality Auditor</h3>  
    //                         <p>Issuing authority ASQ - World Headquarters</p> 
